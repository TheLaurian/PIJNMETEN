...
extern const uint_least8_t              CONFIG_GPIO_LED_D10_CONST;
#define CONFIG_GPIO_LED_D10             0
/* P03 */
extern const uint_least8_t              RSTN_CONST;
#define RSTN                            1
/* P08 */
extern const uint_least8_t              MFIO_CONST;
#define MFIO                            2
...
#define CONFIG_I2C_BMA222E_ADDR     (0x18)
#define CONFIG_I2C_BMA222E_MAXSPEED (400U) /* Kbps */

/* TMP006 address and max speed */
#define CONFIG_I2C_TMP006_ADDR     (0x41)
#define CONFIG_I2C_TMP006_MAXSPEED (3400U) /* Kbps */

/* CONFIG_I2C max speed (specified by the CONFIG_I2C.maxBitRate config setting) */
